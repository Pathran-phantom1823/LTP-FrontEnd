<template>
  ...
  >
      ...
      <v-toolbar flat>
        ...
        <v-dialog v-model="dialog" max-width="500px" persistent>
          <v-card>
            ...
            <v-card-text>
              <v-container>
                <span v-if="isExist" style="color: red"
                  >Username is Unavailable.</span
                >
                <v-text-field
                  ...
                  @input="checkUsername"
                ></v-text-field>
                <span v-if="emailexist" style="color: red"
                  >Email is Unavailable.</span
                >
                <v-text-field
            ...
            <v-card-actions>
              ...
              <v-btn color="blue darken-1" text @click="save(editedItem.id)">
                Save
              </v-btn>
            </v-card-actions>
          </v-card>
    ...
    <template v-slot:item.actions="{ item }">
      ...
      <v-btn small color="orange" @click="deleteItem(item)"> delete </v-btn>
    </template>
