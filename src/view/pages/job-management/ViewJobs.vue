          ...
          <div class="card ViewMoreCard pt-3">
            ...
            <div class="card-body ViewMoreBody">
              <p class="card-text mb-3">
                <b>Price: </b> {{ feedData[0].price }}
              </p>
              <p class="card-text">
                <b> Description : </b>Translate all agricultural documents from
                farming machinery and crop science to agri trade with accuracy
                and speed.Translate all agricultural documents from farming
                machinery and crop science to agri trade with accuracy and
                speed.Translate all agricultural documents from farming
                machinery and crop science to agri trade with accuracy and
                speed.Translate all agricultural documents Translate all
                agricultural documents from farming machinery and crop science
                to agri trade with accuracy and speed.Translate all agricultural
                documents from farming machinery and crop science to agri trade
                with accuracy and speed.Translate all agricultural documents
                from farming machinery and crop science to agri trade with
                accuracy and speed.Translate all agricultural documents
                Translate all agricultural documents from farming machinery and
                crop science to agri trade with accuracy and speed.Translate all
                agricultural documents from farming machinery and crop science
                to agri trade with accuracy and speed.Translate all agricultural
                documents from farming machinery and crop science to agri trade
                with accuracy and speed.Translate all agricultural documents
    ...
    return {
      feedData: [
        ...
        },
        {
          ...
          description:
            "Translate all agricultural documents from farming machinery and crop science to agri trade with accuracy and speed.",
          skills: ["ENGLISH", "RUSSIAN", "FILIPINO"],
          price: "$300",
        },
        {
          title: "Premeiere Translation for the Global Agriculture Industry",
          description:
            "Translate all agricultural documents from farming machinery and crop science to agri trade with accuracy and speed. jashdfkljahsldkfjaslkdjfhaskldjflasdkjf sdjfasdfnajsdfksadflaskjdflkasd;flkasjflkasjdf;lkasjd;lfkjasldf",
          skills: ["ENGLISH", "RUSSIAN", "ARABIC"],
          price: "$300",
        },
      ],
      categories: [
