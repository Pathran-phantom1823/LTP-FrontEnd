    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <div class="projects_container">
          <div class="card project_card" v-for="element in 8" :key="element" @mouseenter="newJobsActionShow" @mouseleave="newJobsActionHide">
            <div class="card-body p-4">
              <div class="row">
                ...
                <div class="col-sm-7 p-0 new_project_info">
                  <div>
                    <div class="mb-1">
                      <b
                        class="mb-2 project_info_title font-weight-normal"
              ...
              <div ref="new_job_action" class="new_job_action">
                ...
                <b class="font-weight-normal new_job_action_element new_job_action_details" @click="viewMore(true)"><i class="mdi mdi-eye mr-2 text-white"></i> Details </b>
              </div>
            </div>
          </div>
        </div>
