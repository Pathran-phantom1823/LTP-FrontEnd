    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <div class="projects_container">
          <div
            class="card project_card"
            v-for="(jobs, newNdx) in returnAcceptedJobs"
            :key="jobs.id"
            @mouseenter="newJobsActionShow"
            @mouseleave="newJobsActionHide"
          >
            <div class="card-body p-4">
              ...
              <div ref="new_job_action" class="new_job_action">
                <button :id="'newJob' + newNdx" @click="selectMember">
                  <b
                    class="font-weight-normal new_job_action_element new_job_action_assign mr-2"
                    role="button"
                  >
                ...
                <b
                  class="font-weight-normal new_job_action_element new_job_action_details"
                  @click="viewMore(true, jobs.id)"
                >
                ...
                <b-popover ref="popover" :target="'newJob' + newNdx" placement="left">
                  ...
                  <div class="assign-card-container">
                    <div class="card assign-card" @click="assignJob" v-for="m in 7" :key="m">
                      <div class="card-body pl-2 pr-2 pt-1 pb-1">
                        ...
                        <b class="font-weight-normal ml-2">Name of the Member</b>
                      </div>
                    </div>
                  </div>
                </b-popover>
            ...
            <div class="card-body p-4">
              ...
              <div class="col-sm-12 p-0 mt-2">
                <div>
                  ...
                  <div>
                    <b
                      class="project_info_details font-weight-normal"
                      @click="viewMore(true)"
                    >Details</b>
                  </div>
                </div>
              ...
              <div class="card-body p-0 d-flex justify-content-between data_header">
                ...
                <div class="saveJobIcon">
                  <i
                    ...
                    title="save job"
                    v-if="String(returnNavEvent.text).toLowerCase() === 'save jobs'"
                  ></i>
                </div>
              </div>
            </div>
