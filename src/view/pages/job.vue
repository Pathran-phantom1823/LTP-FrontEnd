        ...
        >
          ...
          <div class="col-sm-8 card p-0 jobCard">
            <div class="card-body p-3 align-middle">
              ...
              <p class="ViewMoreIcon" @click="viewMore(true)" v-if="String(returnNavEvent.text).toLowerCase() === 'posted jobs'">
                <v-icon
                  title="review bids"
                >mdi mdi-eye</v-icon>
                 view bids
    ...
    <div ref="MoreInfoWrapper" class="MoreInfoWrapper">
      <div ref="moreInfo" class="moreInfo">
        ...
        <div class="card ViewMoreTitle mb-3">
          <b>This section is for view the bids { Initial }</b>
        </div>
      ...
      data: [
        {
          ...
          description:
            "Translate all arts documents from farming machinery and crop science to agri trade with accuracy and speed.",
