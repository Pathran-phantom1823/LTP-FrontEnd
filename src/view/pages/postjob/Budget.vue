    ...
    <v-container>
      <form style="text-align: left">
        ...
        <v-card style="padding: 10px" v-if="hourly">
          ...
          <v-text-field
            outlined
            v-model="paymentNoRange"
            label="Price"
            prepend-inner-icon="mdi-square-inc-cash"
          ></v-text-field>
        </v-card>
        <br />
        <div>
        ...
        <div class="mt-20">
          <v-btn color="primary" @click="next" :disabled="handleNext"
            >Done</v-btn
          >
