        ...
        <div ref="moreInfo" class="moreInfo">
          ...
          <div class="card ViewMoreCard pt-3">
            ...
            <div class="card-body ViewMoreBody">
              <p class="card-text mb-3"><b>Price: </b> {{feedData[0].price}}</p>
              <p class="card-text">
              ...
              <div class="col-sm-12 skillsPadding">
                <div class="row">
                  <b class="skills" v-for="(skill, index) in feedData[0].skills" :key="index">{{skill}}</b>
                </div>
              </div>
            </div>
          ...
          <div class="card ViewMoreCard mt-2">
            ...
            <div class="card-body ViewMoreBody">
              ...
              <div class="col-sm-12 skillsPadding">
                <div class="row">
                  <b class="mr-2"> Category :</b><b class="skills" v-for="skill in 1" :key="skill">Arts Crafts</b>
                </div>
              </div>
            </div>
